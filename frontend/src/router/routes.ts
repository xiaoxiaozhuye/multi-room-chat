...
export const appRoutes: AppRouteRecord[] = [
  { path: '/login', name: 'login', component: () => import('@/views/LoginView.vue'), meta: { title: '登录' } },
  {
    path: '/', component: () => import('@/layouts/AppLayout.vue'), meta: { title: '工作区', requiresAuth: true }, redirect: '/rooms', children: [
      ...
      { path: 'admin/workbench', name: 'admin-workbench', component: WorkbenchView, meta: { title: '管理工作台', requiresAuth: true, roles: ['ROOM_ADMIN', 'SYSTEM_ADMIN'], menu: true, section: '房间管理' } },
      { path: 'admin/rooms', name: 'admin-rooms', component: AdminRoomsView, meta: { title: '房间运营', requiresAuth: true, roles: ['ROOM_ADMIN', 'SYSTEM_ADMIN'], menu: true, section: '房间管理' } },
      { path: 'admin/join-requests', name: 'admin-join-requests', component: JoinRequestsView, meta: { title: '入群审批', requiresAuth: true, roles: ['ROOM_ADMIN', 'SYSTEM_ADMIN'], menu: true, section: '房间管理' } },
      { path: 'admin/review-messages', name: 'admin-review-messages', component: ReviewsView, meta: { title: '内容审核', requiresAuth: true, roles: ['ROOM_ADMIN', 'SYSTEM_ADMIN'], menu: true, section: '房间管理' } },
      { path: 'admin/broadcasts', name: 'admin-broadcasts', component: PublishView, meta: { title: '广播与通知', requiresAuth: true, roles: ['ROOM_ADMIN', 'SYSTEM_ADMIN'], menu: true, section: '房间管理' } },
